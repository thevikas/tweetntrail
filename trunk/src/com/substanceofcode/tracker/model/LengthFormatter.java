...
public class LengthFormatter {
        ...
        switch(distanceUnitType)
        {
            ...
            case UnitConverter.UNITS_KILOMETERS: 
            {
                ...
                double lengthInKilometersOrMeters = UnitConverter.convertLength(
                        ...
                        UnitConverter.UNITS_KILOMETERS,
                        UnitConverter.UNITS_KILOMETERS);
                /* Return length in meter if distance is smaller than a kilometre */
    ...
    public String getUnitString(int distanceUnitType) {
        ...
        switch(distanceUnitType)
        {
            ...
            case UnitConverter.UNITS_KPH:
            {
                units = " km/h";
                break;
            }
            case UnitConverter.UNITS_MPH:
            {
                units = " ml/h";
                break;
            }
    ...
    {
        String speedString = "";
        double speedInCurrentUnit = speed;

        if(!doNotConvert){
            speedInCurrentUnit = UnitConverter.convertSpeed(
                                            speed,
                                            UnitConverter.UNITS_KPH,
                                            this.getSpeedUnitType());
        }
        speedString = StringUtil.valueOf( speedInCurrentUnit, decimalCount );

        if(includeUnits) {
            return speedString + getSpeedUnitString();
        } else {
            return speedString;
        }
    }
    ...
    public String getSpeedString(
            ...
            int decimalCount)
    {
        return getSpeedString(speed, includeUnits, decimalCount, false);
    }
...
/* Get altitude unit as string.
    ...
    public String getSpeedUnitString()
    {
        ...
        unit = getUnitString(this.getSpeedUnitType());
        return unit;
    }
    ...
    /* Get speed unit as string.
     *
     * @return speedUnitType       int of UnitConverter.UNITS_XXX
     */
    public int getSpeedUnitType()
    {
        int speedUnitType;
        ...
        switch(distanceUnitType)
        {
            ...
            {
                /** Speed in MPH */
                speedUnitType = UnitConverter.UNITS_MPH;
                break;
            }
            case UnitConverter.UNITS_NAUTICAL_MILES:
            {
                /** Altitude in meter */
                speedUnitType = UnitConverter.UNITS_KPH;
                break;
            }
            case UnitConverter.UNITS_KILOMETERS:
            {
