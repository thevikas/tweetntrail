...
public abstract class BaseCanvas extends Canvas implements CommandListener {
    ...
    private Command twitterSetupCommand;
    ...
    private void initializeCommands() {
        ...
        geocodeCommand = new Command(LocaleManager.getMessage("menu_find_place"), Command.ITEM, 8);
        addCommand(geocodeCommand);

        twitterSetupCommand = new Command("Twitter Setup", Command.ITEM, 9);
        addCommand(twitterSetupCommand);

        tweetCommand = new Command("Tweet", Command.ITEM, 10);
        addCommand(tweetCommand);


        // Exit command
        exitCommand = new Command(LocaleManager.getMessage("menu_exit"), Command.EXIT, 11);
    ...
    public void commandAction(Command command, Displayable displayable) {
        if (displayable == this) {
            ...
            if (command == twitterSetupCommand) {
