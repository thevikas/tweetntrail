...
public class SplashAndUpdateCanvas extends Canvas implements Runnable {
    ...
    public SplashAndUpdateCanvas() {
        ...
        if(settingsVersion == null){
            ...
            settingsVersion = TweetNTrailMidlet.VERSION;
        }
        
        Version difference = TweetNTrailMidlet.VERSION.compareVersion(settingsVersion);
        ...
        Version version = TweetNTrailMidlet.VERSION;
        versionText = version.toString();
        if(TweetNTrailMidlet.BETA) {
            versionText += " (BETA)";
        }
    }
    ...
    private class Updater extends Thread{
        ...
        public Updater(Version initialVersion){
            ...
            this.finalVersion = TweetNTrailMidlet.VERSION;
        }
