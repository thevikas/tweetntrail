...
public class SurveyorForm extends Form implements CommandListener {
    ...
    private void initializeControls() {
        ...
        nameField.setString(osmPoiPage.getCaption() + " ");
        if(osmPoiPage.getInputType() == 2)
            nameField.setConstraints(TextField.NUMERIC);
    ...
    public void commandAction(Command command, Displayable displayable) {
        ...
        if( command == okCommand ) {
            ...
            osmPoiPage.addInput(name);
            this.osmPoiPage.addPlace(this.osmPoiPage.getName());
